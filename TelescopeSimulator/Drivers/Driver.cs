...
namespace ASCOM.Simulator
{
    ...
    public class Telescope : ReferenceCountedObjectBase, ITelescopeV3
    {
        ...
        public void SetupDialog()
        {
            ...
            {
                EventLogCode.LogEvent("ASCOM.SimulatorCore.Telescope", "Exception on SetupDialog", EventLogEntryType.Error, GlobalConstants.EventLogErrors.TelescopeSimulatorSetup, ex.ToString());
